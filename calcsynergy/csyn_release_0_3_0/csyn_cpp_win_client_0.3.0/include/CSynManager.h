...
namespace csyn {
	...
	*/
	...
	public:
		...
		*/
		void uploadModule(const std::shared_ptr<Module>& module, const std::string& path);
		...
		*/
		void uploadModule(const std::shared_ptr<Module>& module, const std::string& path, int major, int minor);
