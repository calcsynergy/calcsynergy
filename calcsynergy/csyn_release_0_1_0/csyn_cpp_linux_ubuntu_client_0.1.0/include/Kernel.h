...
namespace csyn {
	...
	*/
	...
	public:
		...
		*/
		void setValueByName(const std::string& name, std::shared_ptr<Value>& value);
		...
		* @param value Kernel parameter value
		*/
		void setValueByOrder(int order, std::shared_ptr<Value>& value);
		...
		*/
		void setGlobalValueByName(const std::string& name, const std::string& globalValueName);
		...
		* @param globalValueName global value name
		*/
		void setGlobalValueByOrder(int order, const std::string& globalValueName);
